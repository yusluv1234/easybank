...
let Latestdata = [
    {
        imageUrl: <img src={Currency} alt='online' width="400" height="200" />,
    ...
    {
        imageUrl: <img src={Restaurant} alt='online' width="400" height="200" />,
    ...
    {
        imageUrl: <img src={Plane} alt='online' width="400" height="200" />,
        name: 'By Wilson Hutton',
    ...
    {
        imageUrl: <img src={Confetti} alt='online' width="400" height="200" />,
        name: 'By Claire Robinson',
